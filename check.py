...
class CheckIntegrity(QMainWindow):
    ...
    def save_text_hash(self):
        text = self.text_hash_sha1.toPlainText()+self.text_hash_sha2.toPlainText()+self.text_hash_md5.toPlainText()
    ...
    def open_file_check(self):
        try:
            ...
            if data is not None:
                ...
                self.label_file_check.setText("<font color='red'>Check from file:</font>")
        except:
    ...
    def check_integrity(self):
        ...
        elif len(self.text_check_sha1_1.toPlainText()+self.text_check_sha2_1.toPlainText()+self.text_check_md5_1.toPlainText()) != 136:
            QMessageBox.about(self, "Notifications", "File check is incorrect!")

        elif self.text_hash_sha1.toPlainText() == self.text_check_sha1_1.toPlainText() and \
        self.text_hash_sha2.toPlainText() == self.text_check_sha2_1.toPlainText() \
